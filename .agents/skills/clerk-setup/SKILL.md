...
| Missing middleware matcher | Include API routes; see matcher examples below |
...
| Landing page requires auth | To keep "/" public, exclude it; see matcher examples below |
